...
public class YamlMetaParser extends AbstractBlockParser {
    private static final Pattern REGEX_METADATA = Pattern.compile("^[ ]{0,3}([A-Za-z0-9._-]+)[\\s]*=\\s*(.*)");
    ...
    public static class Factory extends AbstractBlockParserFactory {
        ...
        public BlockStart tryStart(ParserState state, MatchedBlockParser matchedBlockParser) {
            ...
            if (parentParser instanceof DocumentBlockParser && parentParser.getBlock().getFirstChild() == null &&
                ...
                return BlockStart.of(new YamlMetaParser()).atIndex(state.getNextNonSpaceIndex());
            }
